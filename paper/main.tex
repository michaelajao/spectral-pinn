...
The benchmark suite, the finite-volume harness and the surrounding
shallow-water PINN literature come from the comparative study
of~\cite{dambreak2026comparative}, which evaluates classical schemes and
several PINN formulations on six initial-condition variants under identical
conventions. That study supplies both the initial conditions we reproduce and,
through its reference solver output, the independent implementation against
which we check our own reference in Section~\ref{sec:refcheck}.
